...
func _process(_delta):
	if (get_parent() and get_parent().get("GAME_PAUSED") != null and get_parent().GAME_PAUSED) or (
		(get_parent() and get_parent().get_parent() and get_parent().get_parent().get("GAME_PAUSED") != null
		and get_parent().get_parent().GAME_PAUSED)
	):
